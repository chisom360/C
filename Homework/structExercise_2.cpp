...
int main()
{
    ...
    printInfoDisplay1(dummyPrint);
    printInfoDisplay2(&dummyPrint);
...
/*  output
            ...
            Hig School: University of Nigeria Secondary School, Nsukka
             Home town: Imo State, Nigeria       Current College: Normandale Community CollegeCurrent year in school: Graduated
                   Age: 30
          Age in octal: 36
